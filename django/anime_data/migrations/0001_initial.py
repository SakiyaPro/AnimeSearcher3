# Generated by Django 3.2 on 2022-05-03 03:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True, null=True)),
                ('annictId', models.IntegerField(unique=True, verbose_name='AnnictId')),
                ('title', models.CharField(max_length=191, unique=True, verbose_name='タイトル')),
                ...
                ('seasonYear', models.IntegerField(blank=True, null=True, verbose_name='放送年')),
